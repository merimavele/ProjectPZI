...
if ($prijavljeni_korisnik["uloga"] == "Učenik") {
    header("Location: npp3razred_ucenik.php");}
$naslov=" NPP za III razred ";
include("header1.php");
?>
...
$npp = $baza->query('SELECT * FROM npp n  WHERE n.Nazivrazreda = "Treći"');
?>
...
">
    ...
    <div class="col-12 mb-5">
        <h3 class="float-left">Nastavni plan i program za III razred</h3>
