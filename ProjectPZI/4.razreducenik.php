...
$materijali = $baza->query('SELECT * FROM materijali  WHERE Nazivrazreda = "Četvrti" ');?>
...
">
    ...
    <div class="col-12 mb-5">
        ...
        <a class="btn btn-primary float-right mt-1" href="nastavnikprovjera4.php">Nastavnik</a>
