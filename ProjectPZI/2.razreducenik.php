...
$materijali = $baza->query('SELECT * FROM materijali  WHERE Nazivrazreda = "Drugi" ');
?>
...
">
    ...
    <div class="col-12 mb-5">
        ...
        <a class="btn btn-primary float-right mt-1" href="nastavnikprovjera2.php">Nastavnik</a>
