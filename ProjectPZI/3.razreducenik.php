...
$materijali = $baza->query('SELECT * FROM materijali  WHERE Nazivrazreda = "Treći" ');?>
...
">
    ...
    <div class="col-12 mb-5">
        ...
        <a class="btn btn-primary float-right mt-1" href="nastavnikprovjera3.php">Nastavnik</a>
